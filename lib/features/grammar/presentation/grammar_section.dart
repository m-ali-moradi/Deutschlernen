...
/// This class holds a pair of German and English text.
class ExPair {
  final String de;
  final String en;
...
/// This represents a single section of a grammar lesson.
  ...
  factory ExamplesSection.fromJson(Map<String, dynamic> json) {
    return ExamplesSection(
      ...
      items: (json['items'] as List<dynamic>? ?? const <dynamic>[])
          .whereType<Map<String, dynamic>>()
          .map((item) => ExPair(
              (item['de'] ?? '').toString(), (item['en'] ?? '').toString()))
          .toList(),
    );
  }
}
...
/// This class holds all the data for a rich grammar detail page.
